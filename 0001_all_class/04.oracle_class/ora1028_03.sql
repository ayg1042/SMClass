...
2, '유관순', 80, 80, 85, 245, (245)/3, 0
);

insert into students values(
3, '이순신', 90, 90, 91, 271, (271)/3, 0
);
...
-- 사원번호, 사원명, 직급번호 sh clerk사원만 출력하시오.
...
desc employees;
select emp_name, to_char(SALARY * 1384.66, '999,999,999,999') from employees;
